...
ADDRESS_BOOK = [
    ...
    {'AddressBookNumber': '1162491', 'Name': 'NICKELL, DERRICK MASON', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    ...
    {'AddressBookNumber': '112336', 'Name': 'LENGEL JR., STEVEN C.', 'Craft Description': 'CB Elec Days', 'Crew': 'CB Elec Days'},
...
def build_pdf(
    ...
    with PdfPages(buffer) as pdf:
        ...
        # Title page heading
        fig_title.text(0.5, 0.6, "Daily CM Work Order Log", fontsize=24, ha="center")
...
# log of work orders.
st.set_page_config(page_title="Daily CM Work Order Log", layout="wide")
st.title("Daily CM Work Order Log")
