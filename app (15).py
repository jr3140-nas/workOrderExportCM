...
ADDRESS_BOOK = [
    {'AddressBookNumber': '1106018', 'Name': 'DAVIS, JON C.', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1068728', 'Name': 'GOODFRIEND, AVERY PAUL', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1151548', 'Name': 'GRUBBS, CHANCE THOMAS', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1106683', 'Name': 'LAWSON, JASON T.', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1062351', 'Name': 'VEST, JASON NATHANAEL', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1163813', 'Name': 'SPILLMAN, TANNER CHARLES', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'AddressBookNumber': '1068841', 'Name': 'DAY, CHRISTOPHER DEAN', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '110226', 'Name': 'DUNAVENT, NICHOLAS A.', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '148742', 'Name': 'GRIFFIN, NATHANIEL BRIAN', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '150009', 'Name': 'JEFFRIES, NACONA KENT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '1126457', 'Name': 'JEFFRIES, SHELDON TRENT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '140011', 'Name': 'KINMAN, SCOTT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '155125', 'Name': 'NICKELL, DERRICK MASON', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '1133999', 'Name': 'TRUITT, CLAYTON DALE', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '64590', 'Name': 'WILLIAMS, RICHARD C.', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'AddressBookNumber': '1071126', 'Name': 'BURGESS, CLINT DAVID', 'Craft Description': 'BA Elec Days', 'Crew': 'BA Elec Days'},
    {'AddressBookNumber': '1068171', 'Name': 'LENGEL JR., STEVEN C.', 'Craft Description': 'CB Elec Days', 'Crew': 'CB Elec Days'},
    {'AddressBookNumber': '1100960', 'Name': 'BOWLING, AARON DANIEL', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'AddressBookNumber': '105321', 'Name': 'BRITTAIN, TREVOR LEE', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'AddressBookNumber': '1058853', 'Name': 'HALE, JOHN C.', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'AddressBookNumber': '1096681', 'Name': 'ALLEY, NATHAN PAUL', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1131176', 'Name': 'CHAPIN, PATRICK L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1133585', 'Name': 'HENRY JR, MICHAEL SCOTT', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1144612', 'Name': 'HORNBACK, DELBERT R.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1087486', 'Name': 'JONES, ROBERT ETHAN', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '13311', 'Name': 'LEVELL, BRIAN A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1163881', 'Name': 'LEWIS, TREVOR ALEXANDER', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1133016', 'Name': 'LOGAN, JAMES L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1177650', 'Name': 'NIX, ANDREW DAVIS', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '191951', 'Name': 'PELLA, GAVIN DAVID', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1116831', 'Name': 'ROBERTSON, JOSHUA L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1163514', 'Name': 'ROSENBERGER, JADEN ERIC', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1093211', 'Name': 'SPILLMAN, WILLIAM REECE', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1155557', 'Name': 'WALKER, JASON', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1132401', 'Name': 'WALSTON, ROBERT S.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1166387', 'Name': 'CLINE, JOSEPH A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '822590', 'Name': 'CORDELL, ERIC A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1133235', 'Name': 'DENNIS, AUSTIN MCKINLEY', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1115011', 'Name': 'SCUDDER, TRAVIS TODD', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '82114', 'Name': 'SHIELDS, KEVIN L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '810804', 'Name': 'SUTTON, CHRISTOPHER DAVIS', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '221014', 'Name': 'WALSTON, ROBERT COLE', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1162466', 'Name': 'WILSON, MICHAEL DAVID', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1075910', 'Name': 'ADAMS, BRIAN SCOTT', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1071513', 'Name': 'HARTMAN, CONNER MATTHEW', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '864175', 'Name': 'RINGWALD WELCH, DAKOTA DAMION', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'AddressBookNumber': '1134692', 'Name': 'JONES, JACOB MCKAY', 'Craft Description': 'Finishing Elec Days', 'Crew': 'Finishing Elec Days'},
    {'AddressBookNumber': '1095515', 'Name': 'LANGE, ANDREW DAVID', 'Craft Description': 'Finishing Elec Days', 'Crew': 'Finishing Elec Days'},
    ...
    {'AddressBookNumber': '1157190', 'Name': 'ADAMS, ZACHARY KYLE', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '1179911', 'Name': 'CALLIS, DWIGHT T.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '178896', 'Name': 'CARRICO, RICHARD W.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '1087603', 'Name': 'JUMP, MICHAEL STEPHEN', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '362950', 'Name': 'KING, KHRISTIAN B.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '1104477', 'Name': 'MEFFORD, ROGER C.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'AddressBookNumber': '179645', 'Name': 'VARBLE, ROBERT B.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
