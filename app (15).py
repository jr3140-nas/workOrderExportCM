...
# Address book (from AP sheet): name and crew.
# 'Craft Description' is set to the Crew value to align with existing usage.
ADDRESS_BOOK = [
    {'Name': 'DAVIS, JON C.', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'GOODFRIEND, AVERY PAUL', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'GRUBBS, CHANCE THOMAS', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'LAWSON, JASON T.', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'VEST, JASON NATHANAEL', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'SPILLMAN, TANNER CHARLES', 'Craft Description': 'AP Elec Days', 'Crew': 'AP Elec Days'},
    {'Name': 'DAY, CHRISTOPHER DEAN', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'GRIFFIN, NATHANIEL BRIAN', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'JEFFRIES, NACONA KENT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'JEFFRIES, SHELDON TRENT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'KINMAN, SCOTT', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'NICKELL, DERRICK MASON', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'TRUITT, CLAYTON DALE', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'WILLIAMS, RICHARD C.', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'DUNAVENT, NICHOLAS A.', 'Craft Description': 'AP Mech Days', 'Crew': 'AP Mech Days'},
    {'Name': 'BURGESS, CLINT DAVID', 'Craft Description': 'BA Elec Days', 'Crew': 'BA Elec Days'},
    {'Name': 'LENGEL JR., STEVEN C.', 'Craft Description': 'CB Elec Days', 'Crew': 'CB Elec Days'},
    {'Name': 'BOWLING, AARON DANIEL', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'Name': 'BRITTAIN, TREVOR LEE', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'Name': 'HALE, JOHN C.', 'Craft Description': 'CM Elec Aux Days', 'Crew': 'CM Elec Aux Days'},
    {'Name': 'ALLEY, NATHAN PAUL', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'HENRY JR, MICHAEL SCOTT', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'LEVELL, BRIAN A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'LEWIS, TREVOR ALEXANDER', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'PELLA, GAVIN DAVID', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'ROBERTSON, JOSHUA L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'NIX, ANDREW DAVIS', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'LOGAN, JAMES L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'JONES, ROBERT ETHAN', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'ROSENBERGER, JADEN ERIC', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'WALSTON, ROBERT S.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'SPILLMAN, WILLIAM REECE', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'WALKER, JASON', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'HORNBACK, DELBERT R.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'CHAPIN, PATRICK L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'CLINE, JOSEPH A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'CORDELL, ERIC A.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'SCUDDER, TRAVIS TODD', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'SHIELDS, KEVIN L.', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'SUTTON, CHRISTOPHER DAVIS', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'WILSON, MICHAEL DAVID', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'DENNIS, AUSTIN MCKINLEY', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'WALSTON, ROBERT COLE', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'HARTMAN, CONNER MATTHEW', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'RINGWALD WELCH, DAKOTA DAMION', 'Craft Description': 'CM Turns', 'Crew': 'CM Turns'},
    {'Name': 'ADAMS, BRIAN SCOTT', 'Craft Description': 'Elec JCC Trainee', 'Crew': 'Elec JCC Trainee'},
    {'Name': 'JONES, JACOB MCKAY', 'Craft Description': 'Finishing Elec Days', 'Crew': 'Finishing Elec Days'},
    {'Name': 'LANGE, ANDREW DAVID', 'Craft Description': 'Finishing Elec Days', 'Crew': 'Finishing Elec Days'},
    {'Name': 'SPRINGER, BRADLEY ERIC', 'Craft Description': 'Finishing Mech Days', 'Crew': 'Finishing Mech Days'},
    {'Name': 'VANCE, JEFFREY JOEL', 'Craft Description': 'Finishing Mech Days', 'Crew': 'Finishing Mech Days'},
    {'Name': 'WORKS, KEITH E.', 'Craft Description': 'Finishing Mech Days', 'Crew': 'Finishing Mech Days'},
    {'Name': 'AYLER, AARON MICHAEL', 'Craft Description': 'Z Mill Elec Days', 'Crew': 'Z Mill Elec Days'},
    {'Name': 'NUNN, JUSTIN ANTHONY', 'Craft Description': 'Z Mill Elec Days', 'Crew': 'Z Mill Elec Days'},
    {'Name': 'CISSELL, AUSTIN DRAKE', 'Craft Description': 'Z Mill Elec Days', 'Crew': 'Z Mill Elec Days'},
    {'Name': 'SANDLIN, JIMMY LEE', 'Craft Description': 'Z Mill Elec Days', 'Crew': 'Z Mill Elec Days'},
    {'Name': 'CALLIS, DWIGHT T.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'CARRICO, RICHARD W.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'JUMP, MICHAEL STEPHEN', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'KING, KHRISTIAN B.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'VARBLE, ROBERT B.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'WYCOFF, TRISTAN DEVON', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'ADAMS, ZACHARY KYLE', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
    {'Name': 'MEFFORD, ROGER C.', 'Craft Description': 'Z Mill Mech Days', 'Crew': 'Z Mill Mech Days'},
]
